...
The entire explicit key list passes the shared paper-state path check before the
single-flight slot is claimed: invalid components or existing state symlinks yield
422 without scheduling a review or changing job status.
