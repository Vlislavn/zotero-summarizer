...
| **UI: deprecate 4-class chip, show numeric score** | The chip showed must/should/could/dont with κ ≈ 0.04. Replace with a single 0–5 score (or 1–5 rounded) | The 4-class output is statistically indistinguishable from noise; the continuous score has real signal | [web/ui.html](../zotero_summarizer/web/ui.html) (separate frontend pass) |
